...
#         X_train_tier1, 
#         Y_train_dS, 
#         max_features=np.floor(X_train_tier1.shape[0] / 3.0), 
#         show_plots=False
#     )
...
if __name__ == "__main__":
    # Load Raw Data
    smiles_train, Y_train_raw = extract_smiles_and_targets("MTGPR_train.xlsx")
    smiles_test, Y_test_raw = extract_smiles_and_targets("MTGPR_test.xlsx")
